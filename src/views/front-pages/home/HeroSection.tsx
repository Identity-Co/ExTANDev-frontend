...
const HeroSection = ({ mode }: { mode: Mode }) => {
  ...
  const heroSectionBgLight = '/images/front-pages/images/tan-head-ireland.jpg'
  const heroSectionBgDark = '/images/front-pages/images/tan-head-ireland.jpg'
      ...
      <div className={classnames('pbs-16 overflow-hidden', frontCommonStyles.layoutSpacing)}>
        <div className='md:max-is-[550px] mlb-0 mli-auto text-center'>
          <Typography className='font-extrabold text-primary sm:text-[38px] text-3xl mbe-4 leading-[44px]'>
            Adventure <br/> Out There
          </Typography>
          <Typography className='font-medium' color='text.primary'>
            Discover once-in-a-lifetime destinations for those who crave more than just a view.
          </Typography>
          <div className='mbs-8'>
            <Button
              component={Link}
