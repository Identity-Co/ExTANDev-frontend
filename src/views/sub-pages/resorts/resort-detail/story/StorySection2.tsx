            ...
            <div className="container">
                {groupedItems.map((group, groupIndex) => {
                    if (group.type === 'accordion') {
                                            ...
                                            <AccordionDetails>
                                                <div className={classnames(styles.answercont)}>
                                                    <div className={classnames(styles.answer)}>
                                                        ...
                                                        <LikesShare collectionName='resort_story' color='orange' collectionID={recordData?._id} format="comment,like,reply" />
                                                    </div>
                                                </div>
                                            </AccordionDetails>
                                        </Accordion>
                        ...
                        return (
                            <div key={`box-${groupIndex}`} className={classnames(styles.travel_stories_info, 'pb_0')}>
