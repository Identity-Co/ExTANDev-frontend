...
const LandingPageWrapper = ({ mode, banners, pgData, filter_categories, toursData, totalTours, hasParam }: { mode: Mode; banners?: []; pgData?: []; filter_categories?: []; toursData?: []; totalTours?: 0; hasParam?: false }) => {
