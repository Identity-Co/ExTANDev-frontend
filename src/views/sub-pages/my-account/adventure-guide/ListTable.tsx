...
const AdventureGuideListTable = ({ tableData }: { tableData?: adventureguideTypes[] }) => {
  ...
  const fetchData = async () => {
    try {
    // Fetch updated data
    const refresh = await AdventureGuide.getAdventureGuidesByCurrentUser('title,created_at');
      ...
      columnHelper.accessor('action', {
        ...
        cell: ({ row }) => (
          <div className='flex items-center'>
            ...
            <SmartLink href={'/my-account/adventure-guides/edit/'+row.original._id}>
      ...
      <Card>
        <div className='flex justify-between p-5 gap-4 flex-col items-start sm:flex-row sm:items-center'>
          ...
          <div className='flex items-center gap-x-4 gap-4 flex-col max-sm:is-full sm:flex-row'>
            ...
            />
            <SmartLink href={`/my-account/adventure-guides/add/`}>
                ...
                <Card key={row.id} className='p-4'>
                  <div className='space-y-3'>
                    <div className='flex justify-between items-start'>
                      <Typography variant='h6' className='font-medium break-words flex-1'>
                        {row.original.title}
                      </Typography>
                      <div className='flex items-center gap-1 flex-shrink-0'>
                        ...
                        <IconButton 
                          size='small' 
                          sx={{color: 'error.main'}} 
                          onClick={() => handleDeleteList(row.original._id)}
                        >
        ...
        <div className='overflow-x-auto'>
          <TablePagination
            ...
            component='div'
            className='border-bs min-w-[400px]'
