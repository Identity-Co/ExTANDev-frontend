    ...
    <section className={classnames(styles.home_section1, styles.our_desti_sec1)}>
        ...
        {loginErr == 1 && (
          <div className='login-err-msg'>
            <div className="container">
              Please <a href="#" onClick={(e) => { e.preventDefault(); setOpenAccess(true); }}>Login</a> or <a href="#" onClick={(e) => { e.preventDefault(); setOpenAccess(true); }}>Signup</a> to access Cars data.
            </div>
          </div>
        )}
