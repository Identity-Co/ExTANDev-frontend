    ...
    <div className={classnames(styles.home_banner)}>
        <div className={classnames(styles.banner_bg_image)}>
            <div className={classnames(styles.banner_bg_image_hero)}>
                <img src="/images/sub-pages/africa-banner.jpg" />
            </div>
            <div className="container">
                <div className={classnames(styles.banner_bg_image_text, styles.stories_detail_head)}>
                    <h1>Surfing the Wild Side of South Africa</h1>
                </div>
            </div>
        </div>
