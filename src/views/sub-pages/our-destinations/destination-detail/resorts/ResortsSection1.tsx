        ...
        <div className={classnames(styles.container, 'container')}>
            <div className={classnames(styles.destination_overview_tab)}>
                <ul className={classnames(styles.destination_tab)}>
                    ...
                    <li className={classnames(styles.active)}><a href="#">Resorts</a></li>
            ...
            <div className={classnames(styles.head_text_center, 'head_text_center')}>
                <div className={classnames(styles.adventure_right_text)}>
                    <h2 className="fs_70">Check-In to adventure</h2>
                    <p><span className="extra_bold"><em>The Adventure Network is your gateway to the world’s most awe-inspiring places.</em></span> Discover handpicked locations that go beyond the ordinary—each one chosen for its natural beauty, cultural richness, and capacity to ignite your sense of wonder. </p>
