        ...
        <div className={classnames(styles.container, 'container')}>
            <div className={classnames(styles.destination_overview_tab)}>
                <ul className={classnames(styles.destination_tab)}>
                    <li className={classnames(styles.active)}><a href="#">Overview</a></li>
            ...
            <div className={classnames(styles.head_text_center, 'head_text_center')}>
                <div className={classnames(styles.adventure_right_text)}>
                    <h2 className="fs_70">Discover the Dominican Republic</h2>
                    <p><span className="extra_bold"><em>The DR is a playground of peaks, rivers, and rugged beauty—</em></span>perfect for travelers ready to dive deeper into the island experience.</p>
