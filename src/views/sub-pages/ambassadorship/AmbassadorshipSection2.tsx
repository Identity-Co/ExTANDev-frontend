...
const AmbassadorshipSection2 = ({ data }: { data?: []; }) => {
  
  return (
    <section className={classnames(styles.ambassadorship_sec2, 'py_100')}>
        <div className="container">
            <div className={classnames(styles.ambassadorship_sec2_inner)}>
                {data?.about_title && ( 
                    <span className={classnames(styles.next_post, 'extra_bold')}><em>{data.about_title}</em></span>
                )}
                    ...
                    <div className={classnames(styles.biking_right)}>
                        <div className={classnames(styles.network_travel_profile)}>
                            <div className={classnames(styles.network_travel_picture)}>
                                <img src="/images/sub-pages/vagabond.jpg" />
                            </div>
                            <div className={classnames(styles.adv_post_top_right)}>
                                <div className={classnames(styles.network_travel_profile_info)}>
                                    <div className={classnames(styles.network_travel_profile_info_inner)}>
                                        <h4>Adventure vagabond</h4>
                                        <div className={classnames(styles.network_travel_follow)}>
                                            <span>•</span>
                                            <a href="#" tabIndex="-1">FOLLOW</a>
                                        </div>
                                    </div>
                                    <span>@vagabondtravel</span>
                                </div>
                            </div>
                        </div>
                        <p><span className="extra_bold"><em>Joining The Adventure Network’s Ambassador Program has been a game-changer for me.</em></span> I’ve collaborated with brands before, but this was something different—real adventure, real access, and a community that actually lives the lifestyle they promote. From the moment I signed up, I was plugged into a network of creators, guides, and fellow explorers who genuinely support each other.  They don’t just hand you a hashtag—they invite you into the story. If you’re a creator who’s craving something more real, more raw, and way more rewarding, this is it</p>
...
export default AmbassadorshipSection2
