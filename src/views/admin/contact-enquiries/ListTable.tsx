...
import * as ContactEntries from '@/app/server/contact_form_entries'
...
type contactEnquiriesTypesWithAction = contactEnquiriesTypes & {
  action?: string
  first_name?: string
  last_name?: string
...
// Column Definitions
const columnHelper = createColumnHelper<contactEnquiriesTypesWithAction>()

const ContactEnquiriesListTable = ({ tableData }: { tableData?: contactEnquiriesTypes[] }) => {
  ...
  const handleDeleteAction = async () => {
    try {
      const res = await ContactEntries.deleteContactEntry(entryID)
      ...
      toast.error('Error deleting Contact Enquiry');
  ...
  return (
    <>
      ...
      >
        <DialogTitle id='alert-dialog-title' className='text-center'>Delete Contact Enquiry?</DialogTitle>
        <DialogContent>
...
export default ContactEnquiriesListTable
