...
const PageSection = ({ pgData }: { pgData?: [] }) => {  
  ...
  const {
    ...
    defaultValues: {
      ...
      video_title: pgData?.video_title??'',
      youtube_video_url: pgData?.youtube_video_url??'',
  ...
  return (
    <Grid container spacing={6} sx={{ rowGap: 4 }}>
      <Grid size={{ xs: 12 }}>
        <Card>
          <CardHeader title='Page Management - Ambassadorship' />
          <Divider />
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <TextField
                        ...
                        {...((errors.video_title || errorState !== null) && {
                          error: true,
                          helperText: errors?.video_title?.message || errorState?.message[0]
                        })}
                      />
                    )}
                  />
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <TextField
                        ...
                        {...((errors.youtube_video_url || errorState !== null) && {
                          error: true,
                          helperText: errors?.youtube_video_url?.message || errorState?.message[0]
                        })}
                      />
                    )}
                  />
