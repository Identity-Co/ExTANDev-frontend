...
const PageSection = ({ pgData, adventurePosts, allResortsList, resortTags }: { pgData?: []; adventurePosts?: []; allResortsList?: []; resortTags?: [] }) => {  
  ...
  return (
    <Grid container spacing={6} sx={{ rowGap: 4 }}>
      <Grid size={{ xs: 12 }}>
        <Card>
          <CardHeader title='Page Management - Our Destination' />
          <Divider />
