// Component Imports
import CategoryList from '@views/admin/custom-categories/List'

// Data Imports
// import { getUserData } from '@/app/server/actions'
import { getAllCategories } from '@/app/server/custom-categories'
...
export const metadata = {
  title: `Tour Custom Categories - ${config.appName}`,
