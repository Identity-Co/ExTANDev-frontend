...
// Component imports
import AddForm from '@views/admin/sliders/add/AddForm'
...
export const metadata = {
  title: `Add Banners/Sliders - ${config.appName}`,
      ...
      <Grid size={{ xs: 12 }}>
        <Grid container size={{ xs: 12 }} spacing={2} alignItems='center' justifyContent='space-between'>
          <Grid className="flex flex-column gap-4">
            <Typography variant='h4'>Add Banners/Sliders</Typography>
          </Grid>
          <Grid>
            <SmartLink href='/admin/banner-sliders/'>
