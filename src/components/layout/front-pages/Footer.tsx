            ...
            <div className="container">
                <div className={classnames(styles.foot_bot_inner)}>
                    ...
                    <ul className={classnames(styles.foot_social)}>
                        ...
                        <li><Link href={"#"}><svg xmlns="http://www.w3.org/2000/svg" width="10.241" height="19.164" viewBox="0 0 10.241 19.164">
                        ...
                        <li><Link href={"#"}><svg xmlns="http://www.w3.org/2000/svg" width="19.31" height="12.564" viewBox="0 0 19.31 12.564">
                        ...
                        <li><Link href={"#"}><svg xmlns="http://www.w3.org/2000/svg" width="17.008" height="16.772" viewBox="0 0 17.008 16.772">
